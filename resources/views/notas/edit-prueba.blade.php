...
<div class="row">
  <div class="col-lg-9">
    ...
    <div class="card card-primary">
      <div class="card-header color-template">
        <h3 class="card-title"  style="color: #ffffff">Gestión de Notas</h3>
      </div>
  ...
  <div class="col-lg-3">
    ...
    <div class="card card-primary">
      <div class="card-header color-template">
        <h3 class="card-title"  style="color: #ffffff">Evaluaciones</h3>
      </div>
      <div class="card-body my-card-body">
        <ul class="todo-list">
          @foreach ($evaluaciones as $evaluacion)
          <li>
            ...
            <div class="tools">
              ...
              @endif
              <a href="{{ route('evaluaciones.edit', $evaluacion->id) }}" title="Editar"><i class="fa fa-edit"></i></a>
              <a href="" data-target="#modal-delete-{{ $evaluacion->id }}" data-toggle="modal"><i class="fa fa-trash-alt" title="Eliminar"></i></a>
            </div>
          </li>
