...
class AnioController extends Controller
{
    ...
    public function update(AnioRequest $request, $id)
    {
        ...
        if ($request->activo == 1 && $anio->activo == 0) {
            ...
            flash('
                <h4>ERROR</h4>
                <p>Debe activar otro período antes de proceder a inactivar este período.</p>
            ')->error()->important();
    ...
    public function destroy($id)
    {
        ...
        if ($anio->activo == 1) {
            flash('
                <h4>Error al Dar de Baja el Período Académico</h4>
                <p>Este es el período académico en curso, por lo tanto no se puede dar de baja.</p>
            ')->error()->important();
        ...
        flash('
            <h4>Baja de Período</h4>
            <p>El período académico <strong>' . $anio->numero . '</strong> se ha dado de baja correctamente.</p>
        ')->error()->important();
